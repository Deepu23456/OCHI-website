  ...
  return (
    <div data-scroll data-scroll-speed=".001" className="z-20 w-full min-h-screen bg-zinc-900 max-xl:p-10 p-20 flex">
      ...
      <div className="w-1/2 h-full ">
        ...
        <div className="dets max-xl:text-[2vw] max-md:text-[3.3vw] w-full py-5 text-[1.2vw] flex justify-between">
          ...
          <div className="links-container max-md:hidden">
            <h2>M:</h2>
            <div className="links flex flex-col gap-1 mt-6">
              {["home", "services", "insights", "contact us"].map(
                (item, index) => {
                  return (
                    <a key={index} className="capitalize">
                      {item}
        ...
        <div className="rights flex justify-between text-[#90909069]  mt-10">
